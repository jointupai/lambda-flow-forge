      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="mb-12">
            ...
            <div
              id="howdygo-embed"
              className="w-full max-w-[2183px] bg-white border border-[#e2e8f0] rounded-xl overflow-hidden shadow-[0px_0px_1px_rgba(45,55,72,0.05),0px_4px_8px_rgba(45,55,72,0.1)]"
            >
              <script src="https://js.howdygo.com/v1.2.1/index.js"></script>
              <div
                id="howdygo-wrapper"
                className="relative w-full h-0"
                style={{ paddingBottom: "calc(56.5277141548328% + 40px)" }}
              >
                <iframe
                  id="howdygo-frame"
