...
export default function WebhookOrchestration() {
  const useCases = [
    "Custom webhook listeners",
    "Stripe → Slack → CRM → Email flow",
    "Webflow form → analytics + CRM sync"
  ];
      ...
      <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Webhook & API Orchestration</h1>
            <p className="text-xl md:text-2xl text-gray-300">Connect Anything to Everything.</p>
            <p className="mt-8 text-lg text-gray-300 max-w-3xl mx-auto">
              You have tools. We connect them. Our serverless APIs catch data from your forms, apps, CRMs, 
              or Stripe and orchestrate complex, multi-system actions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-brand-primary-400">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6 text-black">Ready to connect your ecosystem?</h2>
            <Button 
              size="lg"
              variant="outline" 
