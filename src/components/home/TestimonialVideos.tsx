...
const VideoCard: React.FC<{ testimonial: Testimonial }> = ({ testimonial }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      <div 
        className="relative w-full aspect-video rounded-lg overflow-hidden cursor-pointer mb-6" 
      ...
      <div className="mt-auto">
        ...
        <Button 
          variant="outline" 
          className="mt-4 rounded-md text-sm px-4 py-2 h-auto border border-gray-300"
        >
          Read customer story
        </Button>
      </div>
